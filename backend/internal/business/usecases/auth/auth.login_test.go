...
func TestLogin(t *testing.T) {
	tests := []struct {
		...
		// wantErrMsg-ийг зөвхөн unauthorized тохиолдлуудад шалгадаг — timing
		// халдлагаас сэргийлэх арга нь "буруу нууц үг" болон "тодорхойгүй email"
		// дээр ижил алдааны текст шаарддаг тул аль зам ашигласныг алдагдуулдаг
		// regression-ийг барихын тулд мессежийг бэхлэдэг.
		wantErrMsg string
	}{
		{
		...
		},
		{
			...
			password: "Pwd_123!",
			setup: func(f *fixture) {
				// 6 дахь оролдлого — fixture 5-аар хязгаарладаг. Түгжилт нь
